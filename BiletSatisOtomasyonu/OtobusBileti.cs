...
namespace BiletSatisOtomasyonu
{
    public partial class OtobusBileti : UserControl
    {
        ...
        private void dgvSeferler_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                biletFiyati = 250; // Otobüs için varsayılan fiyat
            }
        ...
        private void KoltuklariYukle()
        {
            ...
            // Otobüs için 45 koltuk (2+2 düzeni)
            int toplamKoltuk = 45;
        ...
        private void BiletSatinAl()
        {
            try
            {
                ...
                cmdTicket.Parameters.AddWithValue("@ticket", "OTB-" + DateTime.Now.Ticks);
                ...
                cmdSeat.Parameters.AddWithValue("@ticketname", "Otobüs Bileti");
