...
namespace BiletSatisOtomasyonu
{
    public partial class UcakBileti : UserControl
    {
        ...
        private void dgvSeferler_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                biletFiyati = 500; // Uçak için varsayılan fiyat
            }
        ...
        private void KoltuklariYukle()
        {
            ...
            // Uçak için 60 koltuk (6 sıra x 10 kolon)
            int toplamKoltuk = 60;
            ...
            for (int i = 1; i <= toplamKoltuk; i++)
            {
                ...
                btnKoltuk.Size = new Size(45, 45);
                btnKoltuk.FlatStyle = FlatStyle.Flat;
                btnKoltuk.FlatAppearance.BorderSize = 1;
                btnKoltuk.Font = new Font("Segoe UI", 8, FontStyle.Bold);
                btnKoltuk.Tag = i;
                btnKoltuk.Margin = new Padding(3);
        ...
        private void BiletSatinAl()
        {
            try
            {
                ...
                cmdTicket.Parameters.AddWithValue("@ticket", "UCK-" + DateTime.Now.Ticks);
                ...
                cmdSeat.Parameters.AddWithValue("@ticketname", "Uçak Bileti");
